...
public class ThongtinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(21.004341, 105.844252);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Đại học bách khoa hà nội").snippet("64 Giai Phong Ha Noi").icon(BitmapDescriptorFactory.defaultMarker()));
